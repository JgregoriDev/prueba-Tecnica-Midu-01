...
const schema = yup.object().shape({
  ...
  cover: yup
    ...
    .matches(
      /^https?:\/\/.*\.(jpg|jpeg|png|gif|webp|1)$/,
      "La URL de la portada debe ir a un archivo solo se acepta formato PNG, JPG, WEBP o AVIF",
    )
...
export const ModalCustom = ({ addBooksToLS }) => {
